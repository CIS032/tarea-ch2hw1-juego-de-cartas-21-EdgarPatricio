...
public class Blackjack {
    ...
    static boolean jugarBlackjack() {
        ...
        while (true) {
            ...
            System.out.println();
            System.out.print("Jugar (G) o Levantar (L)? ");
            cadena += "Tu total es: " + manoUsuario.getBlackjackValor() + "\nEl repartidor muestra el " + manoRepartidor.getCarta(0)
                    + "\nJugar (G) o Levantar (L)? ";
            String accionUsuario;
            do {
                accionUsuario = lector.nextLine().toUpperCase();
                if (!"J".equals(accionUsuario) && !"L".equals(accionUsuario)) {
                    System.out.print("Por favor responde J o L:  ");
                    cadena += "Por favor responde J o L:  ";
                }
            } while (!"J".equals(accionUsuario) && !"L".equals(accionUsuario));

            if ("L".equals(accionUsuario)) {
                break;
            } else {
